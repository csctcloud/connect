# Generating SSH keys
SSH keys are used to securely connect to the CSCTCloud server using [public key authentication](https://www.ssh.com/academy/ssh/public-key-authentication). You'll need to create keys on any computer you wish to use the server from before being able to connect to it.
